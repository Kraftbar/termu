...
```sh
x86_64-w64-mingw32-gcc termu.c backend_conpty.c -o termu.exe -mwindows -O2 -Wall -municode
./termu.exe &
```
...
Hosts load from `termu_hosts.txt` as `name|command`.
